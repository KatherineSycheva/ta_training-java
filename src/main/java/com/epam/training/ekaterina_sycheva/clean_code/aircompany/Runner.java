...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Airport militaryAirport = new Airport(airport.getListOfPlanesSameType(MilitaryPlane.class));
        Airport passengerAirport = new Airport(airport.getListOfPlanesSameType(PassengerPlane.class));
        System.out.println("Military airport sorted by max distance: " + militaryAirport
                .sortBy(Plane::getMaxFlightDistance)
                .toString());
        System.out.println("Passenger airport sorted by max speed: " + passengerAirport
                .sortBy(Plane::getMaxSpeed)
                .toString());
